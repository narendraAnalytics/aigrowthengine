...
/**
 * Full-screen "we're working on it" overlay shown while the idea-assessment POST
 * is in flight. Cosmetic: it cycles through the real pipeline stages so the wait
 * reads as progress.
 */
